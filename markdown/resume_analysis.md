...
This file contains the prompt for the **Resume Analysis Agent** structured according to the ROCAS flow (Role → Objective → Context → Actions → Structure).
...
* **Extracted Skills:** `{matched_skills}`
