...
JDS_DATA = [
    {
        "title": "Senior Data Scientist", "company": "Innovant", "domain": "Data Science",
        "department": "Analytics", "location": "Remote", "employment_type": "Full-time",
        "work_mode": "Remote", "salary": "$140k - $170k", "experience_level": "Senior",
        ...
        "preferred_skills": ["PyTorch", "Spark", "AWS"], "certifications": [],
        "ai_matching_threshold": 80, "selected_threshold": 90, "waiting_threshold": 75, "status": "Active"
    },
    {
        "title": "Cloud Solutions Architect", "company": "Innovant", "domain": "Engineering",
        "department": "Infrastructure", "location": "Seattle, WA", "employment_type": "Full-time",
        "work_mode": "Hybrid", "salary": "$150k - $190k", "experience_level": "Senior",
        ...
        "ai_matching_threshold": 80, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "DevOps Engineer", "company": "Innovant", "domain": "Engineering",
        "department": "Platform", "location": "Chicago, IL", "employment_type": "Full-time",
        "work_mode": "Hybrid", "salary": "$120k - $150k", "experience_level": "Mid-Level",
        ...
        "ai_matching_threshold": 75, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "Cybersecurity Analyst", "company": "Innovant", "domain": "Security",
        "department": "IT Security", "location": "Washington, DC", "employment_type": "Full-time",
        "work_mode": "On-site", "salary": "$100k - $130k", "experience_level": "Mid-Level",
        ...
        "ai_matching_threshold": 80, "selected_threshold": 85, "waiting_threshold": 75, "status": "Active"
    },
    {
        "title": "Full Stack Engineer", "company": "Innovant", "domain": "Engineering",
        "department": "Product", "location": "Denver, CO", "employment_type": "Full-time",
        "work_mode": "Hybrid", "salary": "$110k - $140k", "experience_level": "Mid-Level",
        "education": "Bachelor's in CS or equivalent",
        ...
        "preferred_skills": ["GraphQL", "Docker", "AWS"], "certifications": [],
        "ai_matching_threshold": 75, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "iOS Developer", "company": "Innovant", "domain": "Mobile",
        "department": "Engineering", "location": "San Francisco, CA", "employment_type": "Full-time",
        "work_mode": "On-site", "salary": "$130k - $160k", "experience_level": "Senior",
        "education": "Bachelor's in CS",
        ...
        "preferred_skills": ["Combine", "XCTest", "CI/CD for Mobile"], "certifications": [],
        "ai_matching_threshold": 75, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "Android Developer", "company": "Innovant", "domain": "Mobile",
        "department": "Engineering", "location": "Remote", "employment_type": "Full-time",
        "work_mode": "Remote", "salary": "$120k - $150k", "experience_level": "Mid-Level",
        "education": "Bachelor's in CS",
        ...
        "preferred_skills": ["RxJava", "Dagger/Hilt", "Firebase"], "certifications": [],
        "ai_matching_threshold": 75, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "Data Engineer", "company": "Innovant", "domain": "Data Science",
        "department": "Data", "location": "Boston, MA", "employment_type": "Full-time",
        "work_mode": "Hybrid", "salary": "$125k - $155k", "experience_level": "Mid-Level",
        ...
        "preferred_skills": ["Kafka", "Hadoop", "dbt"], "certifications": [],
        "ai_matching_threshold": 75, "selected_threshold": 85, "waiting_threshold": 70, "status": "Active"
    },
    {
        "title": "AI/NLP Engineer", "company": "Innovant", "domain": "Data Science",
        "department": "AI Research", "location": "Remote", "employment_type": "Full-time",
        "work_mode": "Remote", "salary": "$140k - $180k", "experience_level": "Senior",
        ...
        "preferred_skills": ["LangChain", "Vector Databases", "ONNX"], "certifications": [],
        "ai_matching_threshold": 85, "selected_threshold": 95, "waiting_threshold": 80, "status": "Active"
    },
    {
        "title": "QA Automation Engineer", "company": "Innovant", "domain": "Engineering",
        "department": "QA", "location": "Dallas, TX", "employment_type": "Full-time",
        "work_mode": "Hybrid", "salary": "$90k - $120k", "experience_level": "Mid-Level",
        ...
        "preferred_skills": ["Appium", "Postman", "Jenkins"], "certifications": ["ISTQB"],
        "ai_matching_threshold": 70, "selected_threshold": 80, "waiting_threshold": 65, "status": "Active"
    },
    {
        "title": "Embedded Systems Engineer", "company": "Innovant", "domain": "Hardware",
        "department": "Engineering", "location": "San Jose, CA", "employment_type": "Full-time",
        "work_mode": "On-site", "salary": "$135k - $165k", "experience_level": "Senior",
        ...
        "preferred_skills": ["Python", "Hardware Debugging", "Bluetooth/Wi-Fi protocols"], "certifications": [],
        "ai_matching_threshold": 80, "selected_threshold": 90, "waiting_threshold": 75, "status": "Active"
    },
    {
        "title": "UI/UX Designer", "company": "Innovant", "domain": "Design",
        "department": "Product", "location": "Remote", "employment_type": "Full-time",
        "work_mode": "Remote", "salary": "$100k - $130k", "experience_level": "Mid-Level",
        ...
        "preferred_skills": ["Adobe Creative Suite", "HTML/CSS basics", "Interaction Design"], "certifications": [],
        "ai_matching_threshold": 70, "selected_threshold": 80, "waiting_threshold": 65, "status": "Active"
    },
]

async def fix_and_load():
    async with AsyncSessionLocal() as db:
        # Fix recruiter role
        await db.execute(text("UPDATE users SET role='recruiter' WHERE email='recruiter@rocas.ai'"))
        await db.commit()
        print("Fixed: recruiter@rocas.ai role set to 'recruiter'")

        # Get recruiter user
        result = await db.execute(select(User).where(User.role.in_(["organization", "recruiter"])))
        user = result.scalars().first()
        if not user:
            print("ERROR: Still no recruiter/org user found!")
            return

        print(f"Using user: {user.email} (role: {user.role})")

        # Check existing JDs to avoid duplicates
        existing = await db.execute(select(JobDescription.title))
        ...
        await db.commit()
        print(f"\nDone! Added {added} new Job Descriptions.")

    await engine.dispose()

if __name__ == "__main__":
    asyncio.run(fix_and_load())
